    ...
    <div className="p-12 bg-gray-900 " >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-20 text-center">
                <Link className="px-4 pt-4 rounded border-neutral-600 text-neutral-700 bg-white hover:bg-neutral-100 font-medium border-2 py-2 inline-block text-center" href="/">
                    View All Webinars
                </Link>
            </div>
        </div>
